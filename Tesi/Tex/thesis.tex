...
%--------------------------------------------------------------
\documentclass[twoside,openany,titlepage,fleqn,
	headinclude,12pt,a4paper,BCOR5mm,footinclude]{scrbook}
%--------------------------------------------------------------
\newcommand{\myItalianTitle}{Analisi e Implementazione di Algoritmi Online per lo Story Scheduling\xspace}
...
\titlespacing*{name=\chapter,numberless}{0pt}{1\baselineskip}{1.2\baselineskip}
\chapter*{Abstract}
